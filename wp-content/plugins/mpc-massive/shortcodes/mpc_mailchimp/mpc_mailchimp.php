...
//			$classes .= $animation != '' ? ' mpc-animation' : '';
		...
		function shortcode_styles( $styles ) {
			...
			if ( $temp_style = MPC_Snippets::css_font( $styles, 'label' ) ) { $inner_styles[] = $temp_style; }
			...
			if ( $temp_style = MPC_Snippets::css_font( $styles, 'input' ) ) { $inner_styles[] = $temp_style; }
			...
			// Radio
			$inner_styles = array();
			if ( $temp_style = MPC_Snippets::css_font( $styles, 'radio' ) ) { $inner_styles[] = $temp_style; }
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'submit' ) ) { $inner_styles[] = $temp_style; }
			if ( $temp_style = MPC_Snippets::css_font( $styles, 'submit' ) ) { $inner_styles[] = $temp_style; }
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'submit_active' ) ) { $inner_styles[] = $temp_style; }
			...
			// Notice
			$inner_styles = array();
			if ( $temp_style = MPC_Snippets::css_font( $styles, 'notice' ) ) { $inner_styles[] = $temp_style; }
