...
if ( ! class_exists( 'MPC_Flipbox' ) ) {
	class MPC_Flipbox {
		...
		function shortcode_styles( $styles ) {
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'front' ) ) { $inner_styles[] = $temp_style; }
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'back' ) ) { $inner_styles[] = $temp_style; }
