...
if ( !class_exists( 'MPC_Pricing_Column' ) ) {
	class MPC_Pricing_Column {
		...
		function shortcode_styles( $styles ) {
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'prop_even' ) ) {
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'featured' ) ) { $inner_styles[] = $temp_style; }
			if ( $temp_style = MPC_Snippets::css_font( $styles, 'featured' ) ) { $inner_styles[] = $temp_style; }
