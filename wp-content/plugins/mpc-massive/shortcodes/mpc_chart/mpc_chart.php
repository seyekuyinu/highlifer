...
if ( ! class_exists( 'MPC_Chart' ) ) {
	class MPC_Chart {
		...
		function shortcode_styles( $styles ) {
			...
			// Icon
			if ( $temp_style = MPC_Snippets::css_icon( $styles ) ) {
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'outer_circle' ) ) { $inner_styles[] = $temp_style; }
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'inner_circle' ) ) { $inner_styles[] = $temp_style; }
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'marker' ) ) { $inner_styles[] = $temp_style; }
			...
			// Value
			if ( ( $temp_style = MPC_Snippets::css_font( $styles, 'value' ) ) && $styles[ 'disable_value' ] == '' && ( $styles[ 'value_text' ] != '' || $styles[ 'value' ] != '' ) ) {
