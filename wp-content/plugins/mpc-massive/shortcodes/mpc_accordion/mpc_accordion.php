...
if ( ! class_exists( 'MPC_Accordion' ) ) {
	...
	class MPC_Accordion {
		...
		function shortcode_template( $atts, $description = null ) {
			...
			$icon_atts = MPC_Snippets::parse_atts_shortcode( $atts, 'mpc_icon_' );
		...
		function shortcode_styles( $styles ) {
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'title' ) ) { $inner_styles[] = $temp_style; }
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'content' ) ) { $inner_styles[] = $temp_style; }
			...
			if ( $temp_style = MPC_Snippets::css_background( $styles, 'hover_title' ) ) { $inner_styles[] = $temp_style; }
