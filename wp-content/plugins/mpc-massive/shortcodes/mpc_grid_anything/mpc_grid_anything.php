		...
		function shortcode_map() {
			...
			$base = array(
				array(
					...
					'edit_field_class' => 'vc_col-sm-12 vc_column mpc-easy-field',
				),
			);
			...
			return array(
				...
				'is_container'            => true,
				'as_parent'               => array( 'only' => 'mpc_alert, mpc_button, mpc_cubebox, mpc_flipbox, mpc_icon, mpc_ihover, mpc_map, mpc_quote, mpc_image, vc_video, vc_column_text, mpc_callout, mpc_chart, mpc_icon_column' ),
