				...
				<table class="mpc-table--status widefat" cellspacing="0">
					...
					<tr>
						<td><?php _e( 'Massive Addons Version', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The version of Massive Addons installed on your site.', 'mpc' ); ?></span></span>
						</td>
					...
					<tr>
						<td><?php _e( 'WP Multisite', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'Whether or not you have WordPress Multisite enabled.', 'mpc' ); ?></span></span>
						</td>
						<td><?php $status_info[ 'WP Multisite' ] = is_multisite(); echo $status_info[ 'WP Multisite' ] ? '&#x2713;' : '&#x2717;'; ?></td>
					</tr>
					<tr>
						<td><?php _e( 'WP Memory Limit', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The maximum amount of memory (RAM) that your site can use at one time.', 'mpc' ); ?></span></span>
						</td>
						<td><?php
					...
					<tr>
						<td><?php _e( 'WP Debug Mode', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'Displays whether or not WordPress is in Debug Mode.', 'mpc' ); ?></span></span>
						</td>
					...
					<tr>
						<td><?php _e( 'Language', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The current language used by WordPress. Default = English', 'mpc' ); ?></span></span>
						</td>
				...
				<table class="mpc-table--status widefat" cellspacing="0">
					...
					<tr>
						<td><?php _e( 'Server Info', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'Information about the web server that is currently hosting your site.', 'mpc' ); ?></span></span>
						</td>
						<td><?php echo $status_info[ 'Server Info' ] = esc_html( $_SERVER['SERVER_SOFTWARE'] ); ?></td>
					</tr>
					<tr>
						<td><?php _e( 'PHP Version', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The version of PHP installed on your hosting server.', 'mpc' ); ?></span></span>
						</td>
						<td><?php
					...
					<?php if ( function_exists( 'ini_get' ) ) : ?>
						<tr>
							<td><?php _e( 'PHP Post Max Size', 'mpc' ); ?>:
								<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The largest filesize that can be contained in one post.', 'mpc' ); ?></span></span>
							</td>
						...
						<tr>
							<td><?php _e( 'PHP Time Limit', 'mpc' ); ?>:
								<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The amount of time (in seconds) that your site will spend on a single operation before timing out (to avoid server lockups)', 'mpc' ); ?></span></span>
							</td>
							<td><?php echo $status_info[ 'PHP Time Limit' ] = ini_get( 'max_execution_time' ); ?></td>
						</tr>
						<tr>
							<td><?php _e( 'PHP Max Input Vars', 'mpc' ); ?>:
								<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The maximum number of variables your server can use for a single function to avoid overloads.', 'mpc' ); ?></span></span>
							</td>
					...
					<tr>
						<td><?php _e( 'MySQL Version', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The version of MySQL installed on your hosting server.', 'mpc' ); ?></span></span>
						</td>
						<td>
							<?php
							/** @global wpdb $wpdb */
					...
					<tr>
						<td><?php _e( 'Max Upload Size', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'The largest filesize that can be uploaded to your WordPress installation.', 'mpc' ); ?></span></span>
						</td>
					...
					$posting['gzip']['help'] = __( 'GZip (gzopen) is used to open the GEOIP database from MaxMind.', 'mpc' );
				...
				<table class="mpc-table--status widefat" cellspacing="0">
					...
					<tr>
						<td><?php _e( 'Child Theme', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'Displays whether or not the current theme is a child theme.', 'mpc' ); ?></span></span>
						</td>
						<td><?php
					...
					<tr>
						<td><?php _e( 'MA Support', 'mpc' ); ?>:
							<span class="mpc-hint">?<span class="mpc-hint-content"><span class="mpc-hint-triangle"></span><?php _e( 'Displays whether or not the current active theme declares Massive Addons support.', 'mpc' ); ?></span></span>
						</td>
