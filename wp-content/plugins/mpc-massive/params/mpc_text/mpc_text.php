...
function mpc_text_settings( $settings, $value ) {
	...
	return sprintf('<div class="mpc-text-input %1$s"%8$s>%2$s <input id="%1$s" name="%3$s" class="wpb_vc_param_value %3$s %4$s_field" type="text" value="%5$s" placeholder="%7$s"><label for="%3$s">%6$s</label></div>',
		$icon_align,
		$icon_wrap,
