...
if ( ! function_exists( 'mpc_presets_preview_modal' ) ) {
	function mpc_presets_preview_modal() { ?>
		<div id="mpc_presets_previews" class="mpc-preset-previews mpc-modal-init">
	...
	if ( $presets !== false ) {
		foreach ( $presets as $name => $preset ) {
			...
			if ( isset( $preset[ '__image' ] ) ) {
				$image = ' data-preset-image="' . esc_url( $preset[ '__image' ] ) . '"';
			}
...
function mpc_get_shortcode_fields() {
	...
	$fields = vc_map_get_attributes( 'mpc_single_post', array() );
