...
define( 'MPC_MASSIVE_VERSION', '1.3' );
define( 'MPC_MASSIVE_MIN', defined( 'MPC_DEBUG' ) && MPC_DEBUG == true ? '' : '.min' );

/* DEV Constants */
//define( 'MPC_MASSIVE_PRESETS', 'mpc_' );
...
//add_action( 'vc_frontend_editor_enqueue_js_css', 'mpc_frontend_enqueue' );
