...
class mymail_campaigns {
	...
	public function post_edit_assets(){
		...
		if (in_array($post->post_status, array('active', 'finished')) || isset($_GET['showstats'])){
			...
			wp_enqueue_script('easy-pie-chart', MYMAIL_URI . 'assets/js/easy-pie-chart'.$suffix.'.js', array('jquery'), MYMAIL_VERSION, true);

			wp_enqueue_style('easy-pie-chart', MYMAIL_URI . 'assets/css/easy-pie-chart'.$suffix.'.css', array(), MYMAIL_VERSION);
			...
			wp_enqueue_style('mymail-codemirror', MYMAIL_URI . 'assets/css/codemirror'.$suffix.'.css', array(), MYMAIL_VERSION);

			if (user_can_richedit()) wp_enqueue_script('editor');

			wp_enqueue_style('jquery-ui-style', MYMAIL_URI . 'assets/css/jquery-ui'.$suffix.'.css', array(), MYMAIL_VERSION);
