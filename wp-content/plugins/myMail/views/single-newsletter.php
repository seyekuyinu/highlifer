					...
					<li class="sharebox-panel-option <?php if(!$is_forward) echo ' active';?>">
						...
						<div>
							...
							foreach($services as $service){
								...
								?>
								<li>
								<a title="<?php echo sprintf(__('Share this via %s', 'mymail'), $social_services[$service]['name']) ?>" class="<?php echo $service ?>" href="<?php echo str_replace('%title', urlencode(get_the_title()), str_replace('%url', urlencode(get_permalink()), htmlentities($social_services[$service]['url']))); ?>" >
